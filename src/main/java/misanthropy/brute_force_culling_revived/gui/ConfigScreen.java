...
public class ConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        }, () -> Component.translatable("brute_force_culling_revived.culling_map_update_delay"))
        ...
        addConfigButton(() -> Config.getCullChunk() && ModLoader.hasSodium() && !ModLoader.hasNvidium(), Config::getAsyncChunkRebuild, Config::setAsyncChunkRebuild, () -> Component.translatable("brute_force_culling_revived.async"))
                .setDetailMessage(() -> {
                    if (ModLoader.hasNvidium()) {
                        return Component.translatable("brute_force_culling_revived.detail.nvidium");
                    } else if (!ModLoader.hasSodium()) {
                        return Component.translatable("brute_force_culling_revived.detail.sodium");
                    } else
        ...
        addConfigButton(Config::getCullBlockEntity, Config::setCullBlockEntity, () -> Component.translatable("brute_force_culling_revived.cull_block_entity"))
                .setDetailMessage(() -> {
                    if (CullingStateManager.gl33()) {
                        return Component.translatable("brute_force_culling_revived.detail.cull_block_entity");
                    } else {
                        return Component.translatable("brute_force_culling_revived.detail.gl33");
                    }
                });
        addConfigButton(Config::getCullEntity, Config::setCullEntity, () -> Component.translatable("brute_force_culling_revived.cull_entity"))
                .setDetailMessage(() -> {
                    if (CullingStateManager.gl33()) {
                        return Component.translatable("brute_force_culling_revived.detail.cull_entity");
                    } else {
                        return Component.translatable("brute_force_culling_revived.detail.gl33");
                    }
                });
