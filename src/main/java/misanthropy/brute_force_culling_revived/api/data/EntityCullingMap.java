...
public class EntityCullingMap extends CullingMap {
    ...
    public static class EntityMap {
        ...
        private @NotNull HashSet<Object> uploadTemp = new HashSet<>();
        private @NotNull HashSet<Object> readTemp = new HashSet<>();
        private @NotNull HashMap<Object, Integer> uploadEntity = new HashMap<>();
        private @NotNull HashMap<Object, Integer> readEntity = new HashMap<>();
        ...
        public void copyTemp(@NotNull EntityMap entityMap, int tickCount) {
